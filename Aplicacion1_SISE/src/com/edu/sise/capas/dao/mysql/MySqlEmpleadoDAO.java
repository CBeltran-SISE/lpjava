...
public class MySqlEmpleadoDAO implements IEmpleadoDAO {
    ...
    final String BUSQUEDA = 
            "SELECT * FROM empleados WHERE nombre LIKE ? || ape_pat like ? || ape_mat like ? ";
    ...
    @Override
    public List<Empleado> obtenerBuscqueda(String v1) throws DAOException {
