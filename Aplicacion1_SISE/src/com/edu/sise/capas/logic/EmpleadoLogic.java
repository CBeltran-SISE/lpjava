...
public class EmpleadoLogic {
    ...
    IEmpleadoDAO dao = factory.geteEmpleadoDAO();
    ...
    public DefaultTableModel obtenerBusqueda(String v1) throws Exception{         
       // List<Empleado> lista  = dao.obtenerBuscqueda(v1);
        return getModelo(modelo, dao.obtenerBuscqueda(v1));
    }
...
//        modelo.addColumn("SUELDO");
      ...
      public int cargaMasiva(String rutaArchivo) throws Exception{
          ...
          int regisstrosAfectados = 0;
             for(int i=0;i<resultados.length;i++){
                 regisstrosAfectados = regisstrosAfectados + resultados[i];
             }
          return regisstrosAfectados; 
