...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mniProvincias = new javax.swing.JMenuItem();
        ...
        jMenu2.add(mniUsuarios);

        mniProvincias.setText("Provincias");
        mniProvincias.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mniProvinciasActionPerformed(evt);
            }
        });
        jMenu2.add(mniProvincias);

        mniCarreras.setText("Carreras");
        mniCarreras.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mniCarrerasActionPerformed(evt);
            }
        });
        jMenu2.add(mniCarreras);
    ...
    private void mniProvinciasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniProvinciasActionPerformed
        // TODO add your handling code here:
        IFrmProvincias IfrmProvincias = new IFrmProvincias();
        this.add(IfrmProvincias);
        IfrmProvincias.show();
        
    }//GEN-LAST:event_mniProvinciasActionPerformed

    private void mniCarrerasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniCarrerasActionPerformed
        IFrmCarreras IfrmCarreras = new IFrmCarreras();
        this.add(IfrmCarreras);
        IfrmCarreras.show();
    ...
    private javax.swing.JMenuItem mniProvincias;
